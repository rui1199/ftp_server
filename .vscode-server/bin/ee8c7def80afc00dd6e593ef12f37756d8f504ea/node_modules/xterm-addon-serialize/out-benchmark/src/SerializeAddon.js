    ...
    _rowEnd(row, isLastRow) {
        ...
        if (!isLastRow) {
            ...
            if (row - this._firstRow >= this._terminal.rows) {
                (_a = this._buffer.getLine(this._cursorStyleRow)) === null || _a === void 0 ? void 0 : _a.getCell(this._cursorStyleCol, this._backgroundCell);
            }
            // Fetch current line
...
class SerializeAddon {
    ...
    serialize(options) {
        ...
        // Normal buffer
        let content = this._serializeBuffer(this._terminal, this._terminal.buffer.normal, options === null || options === void 0 ? void 0 : options.scrollback);
        // Alternate buffer
        if (!(options === null || options === void 0 ? void 0 : options.excludeAltBuffer)) {
        ...
        // Modes
        if (!(options === null || options === void 0 ? void 0 : options.excludeModes)) {
